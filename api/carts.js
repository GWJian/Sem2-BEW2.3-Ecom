...
router.delete("/", auth, async (req, res) => {
  try {
    ...
    if (cart.user != req.user._id)
      return res.json({ msg: "Not allowed or unauthorized" });
  ...
  //FIND CART USING BY THE USER ID WHO IS LOGGED IN IF THEY OWN THE CART DELETE THE CART
  //IF NOT RETURN A RESPONSE SAYIS "Not allowed or unauthorized"
});
